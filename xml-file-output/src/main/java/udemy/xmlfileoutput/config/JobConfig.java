package udemy.xmlfileoutput.config;
...
import udemy.xmlfileoutput.domain.Customer;
import udemy.xmlfileoutput.domain.CustomerRowMapper;
...
public class JobConfig {
    ...
    public Job job() throws Exception {
        String jobName = String.format("xml-file-output-job-%d", new Date().getTime());
