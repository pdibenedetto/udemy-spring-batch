package udemy.filteringitemprocessor.config;
...
import udemy.filteringitemprocessor.domain.Customer;
import udemy.filteringitemprocessor.domain.CustomerLineAggregator;
import udemy.filteringitemprocessor.domain.CustomerRowMapper;
import udemy.filteringitemprocessor.domain.FilteringItemProcessor;
...
//        writer.setLineAggregator(new PassThroughLineAggregator<>());
    ...
    public Job job() throws Exception {
        String jobName = String.format("filtering-item-processor-%d", new Date().getTime());
